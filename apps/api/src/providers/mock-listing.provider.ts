  ...
  private mapToListing(raw: any): NormalizedListing {
    ...
    return {
      ...
      address: {
        ...
        state: statePart || 'XX',
        zip: zipPart || '00000',
        county: addrObj?.county ?? null,
        neighborhood: addrObj?.neighborhood ?? null,
